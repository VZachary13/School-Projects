...
class TicTacToe {
	...
	public static void main(String[] args) {
		...
		//Create a boolean and use it in the while loop
		...
		while(!gameEnded) {
			...
			//Create a char variable based on what player's turn it is
			char c = '-';
			if(player1) {
				c = 'x';
			} else {
			...
			//Only break out of the while loop once the user enters valid position
			while(true) {
				...
				col = in.nextInt();
                    ...
                    System.out.println("Bruh, 0 1 or 2!");
                }
	...
	//Make a function to check if all positions have been filled
